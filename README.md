...
- String 이고, 모양이 json 형태다. (JavaScript Object Notation)
- `{키명: 키값...}`
- `디지털 입장권`처럼 자료요청, 자료등록 등에 서버에 작업시 요청시 활용

## 2. 토큰의 종류

### 2.1. Access Token

- 서버에 자료 요청 및 자료 등록시 활용되는 토큰
- 유효기간이 존재함.

### 2.2. Refresh Token

- 유효기간이 만료시에 Access Token 을 재요청하기 위한 토큰
...
- 자동으로 Access 또는 Refresh 토큰들을 포함해서 요청, 등록을 진행
